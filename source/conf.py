...
project = u'SINF1252 : Messages d\'erreur des compilateurs C'
copyright = u'2017'
...
exclude_patterns = ['build', '.#*', '*/.#*', 'Exercices/QCM/*' ]
...
html_title = u'Messages d\'erreur'
...
latex_documents = [
  ('index', 'SINF1252err.tex', u'SINF1252Err',
   u'', 'manual'),
]
